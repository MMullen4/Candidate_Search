...
const CandidateSearch = () => {
  ...
  return (
    <div className="vh-100 d-flex flex-column justify-content-center align-items-center text-white">
        ...
        >
          ...
          >
            <h5 className="card-title">
              ...
              <span className="fw-bold">({candidate.login})</span>
            </h5>
            <p className="card-text">
              <strong>Location:</strong>{" "}
              {candidate.location || "No location available."}
            </p>
            <p className="card-text">
              <strong>Email:</strong>{" "}
              {candidate.email ? (
            ...
            <p className="card-text">
              ...
              {candidate.company || "No company available."}
            </p>
            <p className="card-text">
